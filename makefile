main: main.c steady_solver.o ssol.o cal_DFDM.o flux.o
	make -C algebra
	make -C pre_proc
	cc -g -Wall -std=c99 main.c ssol.o steady_solver.o cal_DFDM.o flux.o pre_proc/pre_proc.a algebra/algebra.a -fopenmp -lm -DDEBUG
